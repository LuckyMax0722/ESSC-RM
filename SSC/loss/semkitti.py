...
from SSC.loss.lovasz_losses import lovasz_softmax
...
def Lovasz_Softmax_Loss(pred, target, ignore_index=255):
    pred = F.softmax(pred, dim=1)
    lovasz_loss = lovasz_softmax(pred, target, ignore=ignore_index)
